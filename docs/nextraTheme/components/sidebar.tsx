...
const classes = {
  ...
  footer: cn(
    'nextra-sidebar-footer x:border-t nextra-border x:flex x:items-center x:py-4 x:mx-4 x:justify-end',
  ),
}
...
export const MobileNav: FC = () => {
  ...
  const anchors = toc.filter((v: any) => v.depth === 2)
