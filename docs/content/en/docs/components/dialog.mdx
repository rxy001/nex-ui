...
Dialog inherit the props of `as` (by default, `m.div`).
...
DialogContent inherit the props of `as` (by default, `'div'`).
...
DialogHeader inherit the props of `as` (by default, `'h2'`).
...
DialogBody inherit the props of `as` (by default, `'div'`).
...
DialogFooter inherit the props of `as` (by default,`'div'`).
