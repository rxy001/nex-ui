...
You can customize the styles, default properties, etc., of components by using the `components` key in `theme`, which helps achieve style consistency throughout the application.
