...
Some users may set their preference for light or dark mode at the system level through the operating system. Nex UI has built-in support for this feature. You can set `defaultMode: 'system'`.
