...
If you want to change the preset colors in dark mode, you can set it through `semanticTokens`. Check [`semanticTokens`](/docs/customization/semantic-tokens) for more information.
