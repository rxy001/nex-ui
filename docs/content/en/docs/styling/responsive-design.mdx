...
Of course, whether it is an array or an object, the property value of `width` can be modified to [Sizes Tokens](/docs/customization/sizes) and
[Sizes SemanticTokens](/docs/customization/sizes). This also means that other CSS properties also support associated types of Tokens.
...
Learn how to customize breakpoints in [Breakpoints](/docs/customization/breakpoints).
