...
type ModalOwnProps<RootComponent extends ElementType> = {
   ...
   */
  sx?: SxProp<ModalOwnerState<RootComponent>>
...
type ModalContentOwnProps<RootComponent extends ElementType> = {
  as?: RootComponent
  sx?: SxProp<ModalContentOwnerState<RootComponent>>
  children?: ReactNode
  maxWidth?: ModalContentVariants['maxWidth'] | number
...
type ModalHeaderOwnProps<RootComponent extends ElementType> = {
  as?: RootComponent
  sx?: SxProp<ModalHeaderOwnerState<RootComponent>>
  children?: ReactNode
...
type ModalBodyOwnProps<RootComponent extends ElementType> = {
  as?: RootComponent
  sx?: SxProp<ModalBodyOwnerState<RootComponent>>
  children?: ReactNode
...
type ModalFooterOwnProps<RootComponent extends ElementType> = {
  as?: RootComponent
  sx?: SxProp<ModalFooterOwnerState<RootComponent>>
  children?: ReactNode
